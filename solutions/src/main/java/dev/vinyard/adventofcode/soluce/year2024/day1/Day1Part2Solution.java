...
public class Day1Part2Solution implements Solution<Object> {
    ...
    */
    ...
    public Object solve(String input) {
        ...
        List<Long> locationIdLeftList = root.left();
        Map<Long, Long> similarityMap = root.right().stream().collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));

        return locationIdLeftList.stream()
                .mapToLong(left -> similarityMap.getOrDefault(left, 0L) * left)
                .sum();
    }
}
